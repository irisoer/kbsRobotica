...
//
//public class DoosOrder extends VerwerkDoosScherm {
...
//            producten.add(new Product(g.getColor(), x, y));
////            huidigProduct.fillProduct(g, huidigeKleur, doos); //int doos = 2 verdwijnt
//        }
